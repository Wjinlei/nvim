...
local env = {
	JAVA = "/usr/local/jdk-17.0.7/bin/java", -- Java17 or new version
...
local function get_cache_dir()
	return env.XDG_CACHE_HOME and env.XDG_CACHE_HOME or util.path.join(env.HOME, ".cache/jdtls")
end

local function get_mason_dir()
	return global.mason_dir
end

local function get_jdtls_dir()
	return util.path.join(get_mason_dir(), "packages/jdtls")
end
...
local function get_jdtls_config_dir()
	...
	return util.path.join(get_jdtls_dir(), "config_linux")
end

local function get_jdtls_workspace_dir()
	return util.path.join(get_cache_dir(), "workspace")
end

local function get_jdtls_jar()
	return vim.fn.glob(global.mason_dir .. "/packages/jdtls/plugins/org.eclipse.equinox.launcher_*.jar")
end

local function get_lombok()
	return util.path.join(get_jdtls_dir(), "lombok.jar")
end
